...
public class BillPughSingleton {
    ...
    //khi phương thức getInstance() được gọi. Với cách này tránh được lỗi cơ chế khởi tạo instance của Singleton
    //trong Multi-Thread, performance cao do tách biệt được quá trình xử lý. Do đó, cách làm này được đánh giá là
    //cách triển khai Singleton nhanh và hiệu quả nhất.

    //=> Đây là cách hay dùng nhất trong 3 cách
}
